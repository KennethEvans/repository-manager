...
/**
 * PreferencesDialog is a dialog to set the Preferences for RepositoryManager. It only
...
public class PreferencesDialog extends JDialog implements IConstants
{
     ...
     * Constructor
     */
    public PreferencesDialog(Component parent, RepositoryManager viewer) {
        super();
        this.manager = viewer;
        if(viewer == null) {
    ...
    private void init() {
        ...
        button.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent ev) {
                // TODO
                Utils.warnMsg("Not implemented yet.");
        ...
        button.setToolTipText("Set to the RepositoryManager default values.");
        button.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent ev) {
                Settings settings = new Settings();
                if(settings == null) {
