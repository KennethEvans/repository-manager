...
public class AboutBoxPanel extends JPanel
{
    ...
    private static final String DEFAULT_COPYRIGHT = "Copyright (c) 2007, UChicago Argonne, LLC";
    private static final String DEFAULT_COMPANY = "Argonne National Laboratory";
     ...
     */
    public AboutBoxPanel(String name) {
     ...
     */
    public AboutBoxPanel(String name, String author, String company,
        String copyright) {
        this.name = name;
        this.author = author;
    ...
    private void jbInit() throws Exception {
        ...
        this.add(labelName, new GridBagConstraints(0, 0, 1, 1, 0.0, 0.0,
            GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(5, 15,
                2, 15), 0, 0));
        this.add(labelAuthor, new GridBagConstraints(0, 1, 1, 1, 0.0, 0.0,
            GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(5, 15,
                2, 15), 0, 0));
        this.add(labelCompany, new GridBagConstraints(0, 2, 1, 1, 0.0, 0.0,
            GridBagConstraints.WEST, GridBagConstraints.NONE, new Insets(0, 15,
                2, 15), 0, 0));
